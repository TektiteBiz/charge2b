...
#define BANK_SIZE \
  FLASH_BANK1_END /*!< Alias to FLASH_BANK_SIZE definition from HAL STM32L4 */

// #define EE_ACCESS_32BITS                                       /*!< Enable
// EEPROM 32bits R/W functions, only valid for flash allowing 64bits access*/

/* Page state header */
#define EE_PAGESTAT_ERASED                                                    \
  (uint64_t)0xFFFFFFFFFFFFFFFFU /*!< State saved in 1st,2nd,3rd,4th data type \
                                   of page header */
#define EE_PAGESTAT_RECEIVE                                               \
  (uint64_t)0xAAAAAAAAAAAAAAAAU /*!< State saved in 1st data type of page \
                                   header */
#define EE_PAGESTAT_ACTIVE                                                \
  (uint64_t)0xAAAAAAAAAAAAAAAAU /*!< State saved in 2nd data type of page \
                                   header */
#define EE_PAGESTAT_VALID                                                 \
  (uint64_t)0xAAAAAAAAAAAAAAAAU /*!< State saved in 3rd data type of page \
                                   header */
#define EE_PAGESTAT_ERASING                                               \
  (uint64_t)0xAAAAAAAAAAAAAAAAU /*!< State saved in 4th data type of page \
                                   header */
...
#define EE_VIRTUALADDRESS_SHIFT \
  0U /*!< Bits Shifting to get Virtual Address in element */
...
#define START_PAGE_ADDRESS ((uint32_t)0x08008800)

#define CYCLES_NUMBER                                                        \
  12U /*!< Number of 10Kcycles requested, minimum 1 for 10Kcycles (default), \
...
#define CRC_POLYNOMIAL_LENGTH \
  LL_CRC_POLYLENGTH_16B /*!< CRC polynomial length 16 bits */
