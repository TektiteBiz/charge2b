...
// Send a byte to the command regist
void ssd1306_WriteCommand(uint8_t byte) {
	if (DISPLAY1) {
		HAL_I2C_Mem_Write(&SSD1306_I2C_PORT_1, SSD1306_I2C_ADDR, 0x00, 1, &byte, 1, HAL_MAX_DELAY);
	} else {
		HAL_I2C_Mem_Write(&SSD1306_I2C_PORT_2, SSD1306_I2C_ADDR, 0x00, 1, &byte, 1, HAL_MAX_DELAY);
	}
}
...
void ssd1306_WriteData(uint8_t* buffer, size_t buff_size) {
	if (DISPLAY1) {
		HAL_I2C_Mem_Write(&SSD1306_I2C_PORT_1, SSD1306_I2C_ADDR, 0x40, 1, buffer, buff_size, HAL_MAX_DELAY);
	} else {
		HAL_I2C_Mem_Write(&SSD1306_I2C_PORT_2, SSD1306_I2C_ADDR, 0x40, 1, buffer, buff_size, HAL_MAX_DELAY);
	}
}
